...
class TestMcpSaveBearerTokenRoundtrip:
    ...
    @patch('api.routes.get_active_hermes_home')
    @patch('api.routes.get_config')
    def test_masked_bearer_token_preserves_existing_secret(self, mock_cfg, mock_home, mock_reload, fake_agent, tmp_path):
    ...
    @patch('api.routes.get_active_hermes_home')
    @patch('api.routes.get_config')
    def test_new_bearer_token_overwrites_env_and_header(self, mock_cfg, mock_home, mock_reload, fake_agent, tmp_path):
        mock_home.return_value = tmp_path
        mock_cfg.return_value = {
            'mcp_servers': {
                'web-srv': {
